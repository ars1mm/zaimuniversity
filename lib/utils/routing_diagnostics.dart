...
class RoutingDiagnostics {
  ...
  static Future<void> logRouteDiagnostics(String routeName, BuildContext context) async {
    ...
    if (routeName.contains('course')) {
      ...
      _logger.info('- Should access TeacherCourseScreen: ${await _authService.isTeacher()}');
      _logger.info('- Should access CourseManagementScreen: ${await _authService.isAdmin() || await _authService.isSupervisor()}');
